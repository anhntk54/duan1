...
class Khieunai extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('cauhoi_id, user_id, thoigian_khieunai, thoigian_ketthuc, trangthai_nguoithang, trangthai_xuly', 'required'),
			array('cauhoi_id, user_id, trangthai_nguoithang, trangthai_xuly', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, cauhoi_id, user_id, thoigian_khieunai, thoigian_ketthuc, trangthai_nguoithang, trangthai_xuly', 'safe', 'on'=>'search'),
		);
	}
